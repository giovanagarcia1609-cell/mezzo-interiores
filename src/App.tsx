...
const Hero = () => (
  <section id="home" className="relative h-screen min-h-[700px] flex items-center justify-center overflow-hidden">
    ...
    <div className="container mx-auto px-6 relative z-10 text-center">
      ...
      >
        <span className="text-mezzo-light text-[10px] md:text-xs uppercase tracking-[0.8em] mb-8 block font-semibold">Arquitetura & Interiores</span>
        <h1 className="text-5xl md:text-8xl lg:text-9xl font-serif text-white mb-10 leading-[1.1] tracking-tight">
          Transformando <br />
          <span className="gold-text-gradient italic font-light">Espaços em Legados.</span>
        </h1>
  ...
  const services = [
    {
      ...
      desc: "Projetos personalizados que unem estética refinada e funcionalidade inteligente para ambientes residenciais e comerciais."
    },
    {
      icon: <Layout className="w-8 h-8" />,
      title: "Consultoria de Estilo",
      desc: "Curadoria exclusiva de mobiliário, acabamentos e adornos para elevar a atmosfera de espaços já existentes."
    },
    {
      icon: <Hammer className="w-8 h-8" />,
      title: "Gestão de Obras",
      desc: "Acompanhamento técnico rigoroso para garantir que cada detalhe do projeto seja executado com perfeição e fidelidade."
    }
  ];
