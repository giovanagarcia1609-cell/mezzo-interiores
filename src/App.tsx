...
const ProjectCarousel = ({ images, caption }: { images: string[], caption: string }) => {
  ...
  return (
    <div className="mb-16 md:mb-24 last:mb-0 relative w-full">
      ...
      {/* Caption - Exactly as requested */}
      <div className="mt-6 md:mt-8 px-2">
        <h4 className="text-xl md:text-3xl font-serif text-white/90 leading-tight tracking-wide">
          {caption}
        </h4>
      </div>
    </div>
    ...
    <section id="portfolio" className="py-32 bg-darkbrown relative">
      <div className="container mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-24 items-start">
          ...
          <div className="lg:col-span-4 lg:sticky lg:top-32 z-10 mb-12 lg:mb-0">
            <VerticalVideo />
          </div>
          ...
          <div className="lg:col-span-8 space-y-20 lg:space-y-32">
            <ProjectCarousel 
              images={patioImages} 
              caption="São José do Rio Preto – Pátio Pitangueiras" 
            />
            
            <ProjectCarousel 
              images={alamedaImages} 
              caption="São José do Rio Preto – Alameda Iguatemi" 
            />
          </div>
        </div>
      </div>
